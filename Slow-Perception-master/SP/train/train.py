...
# from SP.train.trainer import SPTrainer
# from SP.train.trainer_vit_llrd import SPTrainer
from SP.train.trainer_vit_fixlr import SPTrainer
from SP.model import SPLlamaForCausalLM
from SP.model import *
from SP.data import make_supervised_data_module
from SP.utils.arguments import *
from SP.utils.constants import *
from SP.utils.utils import smart_tokenizer_and_embedding_resize
from SP.model.vision_encoder.sam import build_sam_vit_b
from SP.model.vision_encoder.swin_transformer import build_swin_transformer
def train():
    parser = transformers.HfArgumentParser((ModelArguments, DataArguments, TrainingArguments))
    model_args, data_args, training_args = parser.parse_args_into_dataclasses()

    model = SPLlamaForCausalLM.from_pretrained(
    ...
    # model = SPQwenForCausalLM.from_pretrained(model_args.model_name_or_path, low_cpu_mem_usage=True, device_map='cuda')
