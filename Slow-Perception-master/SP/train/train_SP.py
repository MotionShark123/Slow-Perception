...
def train():
    ...
    model = SPQwenForCausalLM.from_pretrained(model_args.model_name_or_path, use_safetensors=True)
    ...
    # model.get_model().vision_tower_high = build_vary_vit_b(checkpoint='/data/mmgpt-all-master/scripts/sam_b_pair.bin')
