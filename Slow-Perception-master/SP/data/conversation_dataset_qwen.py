...
from SP.data.base_dataset import BaseDataset
from SP.utils.constants import *
from SP.utils import conversation as conversation_lib
import boto3
import smart_open
...
class ConversationDataset(BaseDataset):
    ...
    def __init__(self, datasets, tokenizer, multimodal_cfg):
        ...
        for name_all in datasets.split("+"):
            for name in SP_data_dict[name_all]:
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if isinstance(data, dict) and 'image' in data:
            ...
            # Vary for two image, SP does not use the data_dict['image]
