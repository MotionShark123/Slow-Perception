...
train_transform = alb_wrapper(
    alb.Compose(
        [
            ...
            alb.RandomBrightnessContrast(0.3, 0.3, True, p=0.1),
            alb.ImageCompression(quality_lower=30, quality_upper=90, p=0.2),
            alb.GaussNoise(var_limit=(0.0, 1000.0), p=0.05),
            alb.GaussianBlur((3, 3), p=0.2),
